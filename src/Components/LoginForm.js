    ...
    return (
        <form className='w-full' onSubmit={(e)=>e.preventDefault()}>
            ...
            <div className="w-4/12 h-[500px] bg-black mx-auto bg-opacity-80 text-white flex-col items-start pt-10 rounded-md">
                ...
                <button type='submit' className="w-9/12 my-3 bg-red-600 ml-14 p-2 rounded-md font-semibold hover:bg-red-700" onClick={handleSubmit}>{(isLogin) ? <>Sign In</> : <>Sign Up</>}</button>
                {
